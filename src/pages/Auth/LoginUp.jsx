...
function LoginUp() {
    ...
    const [emailFocused, setEmailFocused] = useState(false); // Added state for email focus
    const [passwordFocused, setPasswordFocused] = useState(false); // Added state for password focus
